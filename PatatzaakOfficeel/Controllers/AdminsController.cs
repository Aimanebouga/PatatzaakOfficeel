...
namespace PatatzaakOfficeel.Controllers
{
    public class AdminsController : Controller
    {
        ...
        public AdminsController(PatatzaakDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Admins != null ? 
                          ...
                          Problem("Entity set 'PatatzaakDBContext.Admins'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PatatzaakDBContext.Admins'  is null.");
            }
            var admin = await _context.Admins.FindAsync(id);
            if (admin != null)
            {
